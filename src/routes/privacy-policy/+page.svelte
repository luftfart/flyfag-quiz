...
<div class="text-primary prose max-w-2xl mx-auto">
    ...
    <p>
        ...
        absolute data security. We will comply with laws applicable to us in respect of any data
        breach.
    </p>
    <p>
    ...
    <p>
        ...
        personal information is no longer required, we will delete it or make it anonymous by removing
    ...
    <ul>
        ...
        <li>
            ...
            for example, IT service providers, data storage, hosting and server providers, advertisers,
    ...
    <p>
        ...
        to which we store, process, or transfer your personal information may not have the same data
        protection laws as the country in which you initially provided the information. If we transfer
        your personal information to third parties in other countries: (i) we will perform those
        transfers in accordance with the requirements of applicable law; and (ii) we will protect the
    ...
    <p>
        ...
        exercising any of your rights over your personal information. If you do provide us with
    ...
    <p>
        ...
        unsubscribe from our email-database or opt out of communications. Please be aware we may need
    ...
    <p>
        ...
        irrelevant, or misleading, please contact us using the details provided in this privacy

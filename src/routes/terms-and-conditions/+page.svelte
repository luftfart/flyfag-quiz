...
<div class="text-primary prose max-w-2xl mx-auto">
    ...
    <h3 class="text-warning font-bold py-4">Restrictions</h3>
    ...
    <h3 class="text-warning font-bold py-4">Your Content</h3>
    <p>
    ...
    <h3 class="text-warning font-bold py-4">Severability</h3>
    <p>
    ...
    <p>
        These Terms will be governed by and interpreted in accordance with the laws of Norway, and you submit to the non-exclusive jurisdiction of the state and federal courts located
        in Norway for the resolution of any disputes.
    </p>
</div>
</div>